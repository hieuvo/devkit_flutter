import 'package:devkitflutter/library/route_transition/rotation_route.dart';
...
class RotationRouteAnimationPage extends StatefulWidget {
  const RotationRouteAnimationPage({super.key});

  @override
  State<RotationRouteAnimationPage> createState() => _RotationRouteAnimationPageState();
}
            ...
            children: [
              ...
              Container(
                ...
                child: _globalWidget.createButton(
                    ...
                    onPressed: (){
                      Navigator.push(context, RotationRoute(page: const DestinationPage()));
                    }
                ),
              ),
            ],
