import 'package:devkitflutter/library/route_transition/fade_route.dart';
...
class FadeRouteAnimationPage extends StatefulWidget {
  const FadeRouteAnimationPage({super.key});

  @override
  State<FadeRouteAnimationPage> createState() => _FadeRouteAnimationPageState();
}
            ...
            children: [
              ...
              Container(
                ...
                child: _globalWidget.createButton(
                    ...
                    onPressed: (){
                      Navigator.push(context, FadeRoute(page: const DestinationPage()));
                    }
                ),
              ),
            ],
