...
class WithoutAnimationPage extends StatefulWidget {
  const WithoutAnimationPage({super.key});

  @override
  State<WithoutAnimationPage> createState() => _WithoutAnimationPageState();
}
            ...
            children: [
              ...
              Container(
                ...
                child: _globalWidget.createButton(
                    ...
                    onPressed: (){
                      Navigator.of(context).push(PageRouteBuilder(pageBuilder: (_,__,___)=> const DestinationPage()));
                    }
                ),
              ),
            ],
