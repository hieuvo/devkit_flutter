...
class SizeRouteAnimationPage extends StatefulWidget {
  const SizeRouteAnimationPage({super.key});

  @override
  State<SizeRouteAnimationPage> createState() => _SizeRouteAnimationPageState();
}
            ...
            children: [
              ...
              Container(
                ...
                child: _globalWidget.createButton(
                    ...
                    onPressed: (){
                      Navigator.push(context, SizeRoute(page: const DestinationPage()));
                    }
                ),
              ),
            ],
