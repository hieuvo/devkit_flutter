...
import 'package:devkitflutter/ui/feature/auto_complete/destination.dart';
...
class AutoCompleteNavigationPage extends StatefulWidget {
  const AutoCompleteNavigationPage({super.key});

  @override
  State<AutoCompleteNavigationPage> createState() => _AutoCompleteNavigationPageState();
}
