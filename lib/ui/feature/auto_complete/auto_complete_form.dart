...
class AutoCompleteFormPage extends StatefulWidget {
  const AutoCompleteFormPage({super.key});

  @override
  State<AutoCompleteFormPage> createState() => _AutoCompleteFormPageState();
}
              ...
              Container(
                ...
                child: TypeAheadFormField(
                  textFieldConfiguration: TextFieldConfiguration(
                    decoration: const InputDecoration(labelText: 'Search Fruit'),
