...
class DestinationPage extends StatefulWidget {
  ...
  const DestinationPage({super.key, required this.productData});
...
class _DestinationPageState extends State<DestinationPage> {
  ...
  final Color _color2 = const Color(0xFFaaaaaa);
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text('(${widget.productData.review})', style: TextStyle(
                            fontSize: 11,
                            color: _color2
                        ))
                      ],
                  ...
                  Container(
                    margin: const EdgeInsets.only(top: 5),
                    child: Text('${widget.productData.sale} Sale',
                        style: TextStyle(
                            fontSize: 11,
                            color: _color2
                        )),
