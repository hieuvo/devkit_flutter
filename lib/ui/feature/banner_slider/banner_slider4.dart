...
class BannerSlider4Page extends StatefulWidget {
  const BannerSlider4Page({super.key});

  @override
  State<BannerSlider4Page> createState() => _BannerSlider4PageState();
}
...
class _BannerSlider4PageState extends State<BannerSlider4Page> {
  ...
  @override
  void initState() {
    bannerData.add(BannerSliderModel(id: 1, image: '$globalUrl/home_banner/1.jpg'));
    bannerData.add(BannerSliderModel(id: 2, image: '$globalUrl/home_banner/2.jpg'));
    bannerData.add(BannerSliderModel(id: 3, image: '$globalUrl/home_banner/3.jpg'));
    bannerData.add(BannerSliderModel(id: 3, image: '$globalUrl/home_banner/4.jpg'));
    bannerData.add(BannerSliderModel(id: 3, image: '$globalUrl/home_banner/5.jpg'));
    super.initState();
  }
      ...
      body: ListView(
        children: [
          ...
          Column(
            children: [
              CarouselSlider(
                items: bannerData.map((item) => ClipRRect(
