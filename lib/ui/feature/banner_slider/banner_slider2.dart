...
class BannerSlider2Page extends StatefulWidget {
  const BannerSlider2Page({super.key});

  @override
  State<BannerSlider2Page> createState() => _BannerSlider2PageState();
}
...
class _BannerSlider2PageState extends State<BannerSlider2Page> {
  ...
  @override
  void initState() {
    _bannerData.add(BannerSliderModel(id: 1, image: '$globalUrl/category_banner/1.jpg'));
    _bannerData.add(BannerSliderModel(id: 2, image: '$globalUrl/category_banner/2.jpg'));
    _bannerData.add(BannerSliderModel(id: 3, image: '$globalUrl/category_banner/3.jpg'));
    super.initState();
  }
