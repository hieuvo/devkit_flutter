...
class BannerSlider7Page extends StatefulWidget {
  const BannerSlider7Page({super.key});

  @override
  State<BannerSlider7Page> createState() => _BannerSlider7PageState();
}
...
class _BannerSlider7PageState extends State<BannerSlider7Page> with TickerProviderStateMixin {
  ...
  void setupAnimateAppbar(){
    ...
    _topColorAnimationController = AnimationController(vsync: this, duration: const Duration(seconds: 0));
