...
import 'package:devkitflutter/ui/feature/signature/signature_result.dart';
...
class Signature2Page extends StatefulWidget {
  const Signature2Page({super.key});

  @override
  State<Signature2Page> createState() => _Signature2PageState();
}
