...
class CustomLanguagePage extends StatefulWidget {
  const CustomLanguagePage({super.key});

  @override
  State<CustomLanguagePage> createState() => _CustomLanguagePageState();
}
...
class _CustomLanguagePageState extends State<CustomLanguagePage> {
  ...
  final List<String> _localeList = ['en', 'id', 'tk'];
  final List<String> _countryList = ['US', 'ID', 'TK'];
