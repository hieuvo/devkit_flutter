...
class _Chat1PageState extends State<Chat1Page> {
  ...
  void initState() {
    setState(() {
      ...
      _chatList.add(ChatModel(2, 'buyer', 'text', 'Good morning', '13:59', true));
      _chatList.add(ChatModel(3, 'buyer', 'image', '$globalUrl/product/80.jpg', null, null));
      _chatList.add(ChatModel(4, 'buyer', 'text', 'I want to ask about the samsung tv product', '13:59', true));
      _chatList.add(ChatModel(5, 'buyer', 'text', 'Is the Samsung LED TV 32 Inch is still on sale ?', '14:01', true));
      _chatList.add(ChatModel(6, 'seller', 'text', 'Hello, thank you for contacting us', '14:18', true));
      _chatList.add(ChatModel(7, 'seller', 'text', 'We are sorry, but the promotion for Samsung LED TV 32 Inch has ended. Don\'t forget to turn on notification setting for promotion so you will get the news about our product', '14:20', null));
      _chatList.add(ChatModel(8, 'buyer', 'text', 'Ok, thank you for your information.', '14:22', true));
      _chatList.add(ChatModel(9, null, 'date', '13 Sep 2019', null, null));
      _chatList.add(ChatModel(10, 'buyer', 'image', '$globalUrl/product/21.jpg', null, null));
      _chatList.add(ChatModel(11, 'buyer', 'text', 'Hi, is Adidas Polo Shirt size L is ready ? For the black color.', '08:58', true));
      _chatList.add(ChatModel(12, 'buyer', 'text', 'I want to order for 2 pcs.', '09:00', true));
      _chatList.add(ChatModel(13, 'buyer', 'text', "And can I change it if the size doesn't fit my body?", '09:00', true));
      _chatList.add(ChatModel(14, 'seller', 'text', 'Hello, good morning. The product is ready and you can change if the size is not fit your body', '09:14', null));
  ...
  void _addDate(String currentDate){
    _chatListReversed.insert(0, ChatModel(15, null, 'date', currentDate, null, null));
  }

  void _addMessage(String message){
    DateTime now = DateTime.now();
    String currentTime = DateFormat('kk:mm').format(now);
    _chatListReversed.insert(0, ChatModel(16, 'buyer', 'text', message, currentTime, false));
  }
              ...
              children: [
                ...
                Wrap(
                  children: [
                    ...
                    Icon(Icons.done_all, color: read==true?primaryColor:softGrey, size: 11),
                    const SizedBox(width: 2),
                    Text(time, style: const TextStyle(
                        color: softGrey, fontSize: 9
                    )),
                  ],
                )
              ],
