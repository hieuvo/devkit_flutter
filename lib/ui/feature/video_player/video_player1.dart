...
class VideoPlayer1Page extends StatefulWidget {
  const VideoPlayer1Page({super.key});

  @override
  State<VideoPlayer1Page> createState() => _VideoPlayer1PageState();
}
          ...
          children: [
            Container(
              child: _globalWidget.createDetailWidget(
                  ...
                  desc: 'This is the example of video player from local source / assets.\nVideo by Pixabay'),
            ),
            Container(
