...
class ChartsPackageListPage extends StatefulWidget {
  const ChartsPackageListPage({super.key});

  @override
  State<ChartsPackageListPage> createState() => _ChartsPackageListPageState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ListView(
          ...
          children: [
            const Text('Charts Package', style: TextStyle(
            ...
            _globalWidget.screenDetailList(context: context, title: 'Syncfusion Flutter Charts', page: const SyncfusionListPage()),
          ],
        )
    );
  }
