          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                  ...
                  child: const Text('Without half rating')
              ),
              Container(
                ...
                child: SmoothStarRating(
                  ...
                  onRated: (value) {
                    _rating1 = value;
                    Fluttertoast.showToast(msg: 'Rating value : $_rating1', toastLength: Toast.LENGTH_SHORT);
                  },
                ),
              ),
              ...
              Container(
                ...
                child: SmoothStarRating(
                  ...
                  onRated: (value) {
                    _rating2 = value;
                    Fluttertoast.showToast(msg: 'Rating value : $_rating2', toastLength: Toast.LENGTH_SHORT);
                  },
                ),
              ),
              _globalWidget.createButton(
