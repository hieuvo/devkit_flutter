...
class BottomNavigation8Page extends StatefulWidget {
  const BottomNavigation8Page({super.key});

  @override
  State<BottomNavigation8Page> createState() => _BottomNavigation8PageState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: ConvexAppBar(
        style: TabStyle.fixed, // if you are using fixed type, the TabItem must be odd number
