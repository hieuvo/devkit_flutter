...
class ProductList3Page extends StatefulWidget {
  const ProductList3Page({super.key});

  @override
  State<ProductList3Page> createState() => _ProductList3PageState();
}
...
class _ProductList3PageState extends State<ProductList3Page> {
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Text('(${productData.review})', style: const TextStyle(
                                      fontSize: 11,
                                      color: softGrey
                                  ))
                                ],
                            ...
                            Container(
                              margin: const EdgeInsets.only(top: 5),
                              child: Text('${productData.sale} Sale',
                                  style: const TextStyle(
                                      fontSize: 11,
                                      color: softGrey
                                  )),
  ...
  void showPopupDeleteFavorite(index, boxImageSize) {
    ...
    AlertDialog alert = AlertDialog(
      ...
      title: const Text('Delete Favorite', style: TextStyle(fontSize: 18),),
