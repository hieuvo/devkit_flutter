...
class ProductList2Page extends StatefulWidget {
  const ProductList2Page({super.key});

  @override
  State<ProductList2Page> createState() => _ProductList2PageState();
}
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text('\$ ${_globalFunction.removeDecimalZeroFormat(_productData[index].price!)}',
                        ...
                        Container(
                          margin: const EdgeInsets.only(top: 5),
                          child: Text('${_productData[index].sale} Sale',
                              style: const TextStyle(
                                  fontSize: 11,
                                  color: softGrey
                              )),
