...
class Signin3Page extends StatefulWidget {
  const Signin3Page({super.key});

  @override
  State<Signin3Page> createState() => _Signin3PageState();
}
...
class _Signin3PageState extends State<Signin3Page> {
  ...
  final Color _color1 = const Color(0xFFB226B2);
  final Color _color2 = const Color(0xFFFF4891);
  final Color _color3 = const Color(0xFFFF6DA7);
