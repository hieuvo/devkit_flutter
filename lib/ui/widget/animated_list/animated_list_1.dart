...
class AnimatedList1Page extends StatefulWidget {
  const AnimatedList1Page({super.key});

  @override
  State<AnimatedList1Page> createState() => _AnimatedList1PageState();
}
...
class _AnimatedList1PageState extends State<AnimatedList1Page> {
  ...
  final List<String> _data = ['item 1', 'item 2', 'item 3', 'item 4', 'item 5'];
