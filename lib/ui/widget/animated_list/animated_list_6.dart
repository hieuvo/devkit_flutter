...
class AnimatedList6Page extends StatefulWidget {
  const AnimatedList6Page({super.key});

  @override
  State<AnimatedList6Page> createState() => _AnimatedList6PageState();
}
...
class _AnimatedList6PageState extends State<AnimatedList6Page> {
  ...
  @override
  void initState() {
    _delayData.add('item ${_random.nextInt(255)}');
    _delayData.add('item ${_random.nextInt(255)}');
    _delayData.add('item ${_random.nextInt(255)}');
    _loadItems();
    super.initState();
