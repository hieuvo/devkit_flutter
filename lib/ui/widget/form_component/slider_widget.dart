...
class SliderWidgetPage extends StatefulWidget {
  ...
  @override
  State<SliderWidgetPage> createState() => _SliderWidgetPageState();
}
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: const Text('Standart slider'),
              ),
              Container(
              ...
              Container(
                ...
                child: const Text('Without label'),
              ),
              Container(
                  margin: const EdgeInsets.symmetric(vertical: 8),
                  child: Slider(
              ...
              Container(
                margin: const EdgeInsets.only(top: 20),
                child: const Text('Without divisions'),
              ),
              Container(
                  margin: const EdgeInsets.symmetric(vertical: 8),
                  child: Slider(
              ...
              Container(
                margin: const EdgeInsets.only(top: 20),
                child: const Text('Change color & show label'),
              ),
              Container(
                  margin: const EdgeInsets.symmetric(vertical: 8),
                  child: SliderTheme(
              ...
              Container(
                margin: const EdgeInsets.only(top: 20),
                child: const Text('Change inactive color & label size'),
              ),
              Container(
                  margin: const EdgeInsets.symmetric(vertical: 8),
                  child: SliderTheme(
