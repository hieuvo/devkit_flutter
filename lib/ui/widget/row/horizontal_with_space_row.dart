...
class HorizontalWithSpaceRowPage extends StatefulWidget {
  const HorizontalWithSpaceRowPage({super.key});

  @override
  State<HorizontalWithSpaceRowPage> createState() => _HorizontalWithSpaceRowPageState();
}
        ...
        body: ListView(
          ...
          children: [
            ...
            Container(
                ...
                child: const Text('Align center & give same space left right at all container')
            ),
            Container(
