...
class FirestoreCreatePage extends StatefulWidget {
  const FirestoreCreatePage({super.key});

  @override
  State<FirestoreCreatePage> createState() => _FirestoreCreatePageState();
}
...
class _FirestoreCreatePageState extends State<FirestoreCreatePage> {
  ...
  final CollectionReference _studentCollections = FirebaseFirestore.instance.collection('students');
