...
class GoogleMaps15Page extends StatefulWidget {
  const GoogleMaps15Page({super.key});

  @override
  State<GoogleMaps15Page> createState() => _GoogleMaps15PageState();
}
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          Container(
            margin: const EdgeInsets.all(16),
            child: Text(_address==''?'This is address text.':_address, style: const TextStyle(
                color: black77,
                fontSize: 16
            )),
          ),
