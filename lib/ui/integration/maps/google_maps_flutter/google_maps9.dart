...
class GoogleMaps9Page extends StatefulWidget {
  const GoogleMaps9Page({super.key});

  @override
  State<GoogleMaps9Page> createState() => _GoogleMaps9PageState();
}
...
class _GoogleMaps9PageState extends State<GoogleMaps9Page> {
  ...
  @override
  void initState() {
    _markerList.add(const LatLng(-6.168033, 106.900467));
    _markerList.add(const LatLng(-6.164770, 106.900630));
    _markerList.add(const LatLng(-6.158637, 106.906376));
    super.initState();
  }
