...
class GoogleMaps11Page extends StatefulWidget {
  const GoogleMaps11Page({super.key});

  @override
  State<GoogleMaps11Page> createState() => _GoogleMaps11PageState();
}
...
class _GoogleMaps11PageState extends State<GoogleMaps11Page> {
  ...
  @override
  void initState() {
    _latlng.add(const LatLng(-6.168033, 106.900467));
    _latlng.add(const LatLng(-6.164770, 106.900630));
    _latlng.add(const LatLng(-6.158637, 106.906376));
