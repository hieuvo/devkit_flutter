            ...
            child: BlocListener<ProductGridBloc, ProductGridState>(
              listener: (context, state) {
                ...
                if (state is GetProductGridSuccess) {
                  ...
                  if (state.productGridData.isEmpty) {
                    _lastData = true;
                  } else {
                    _apiPage += _apiLimit;
              ...
              child: Column(
                ...
                children: [
                  Text(
                    ...
                    style:
                        const TextStyle(fontSize: 12, color: Color(0xFF515151)),
                    maxLines: 2,
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                            '\$ ${_globalFunction.removeDecimalZeroFormat(productGridData[index].price)}',
                            style: const TextStyle(
                                fontSize: 13, fontWeight: FontWeight.bold)),
                        Text('${productGridData[index].sale} Sale',
                            style: const TextStyle(
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Text('(${productGridData[index].review})',
                            style: const TextStyle(
                                fontSize: 11, color: Color(0xFFaaaaaa)))
                      ],
                    ),
