          ...
          child: BlocListener<ProductListviewBloc, ProductListviewState>(
            listener: (context, state) {
              ...
              if (state is GetProductListviewSuccess) {
                ...
                if (state.productListviewData.isEmpty) {
                  _lastData = true;
                } else {
                  _apiPage += _apiLimit;
              ...
              builder: (context, state) {
                if (state is ProductListviewError) {
                  ...
                  if (_lastData && _apiPage == 0) {
                    ...
                    if (productListviewData.isEmpty) {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                              '\$ ${_globalFunction.removeDecimalZeroFormat(productListviewData[index].price)}',
                              style: const TextStyle(
                          ...
                          child: Row(
                            children: [
                              _globalWidget.createRatingBar(
                                  ...
                                  size: 12),
                              Text('(${productListviewData[index].review})',
                                  style: const TextStyle(
                                      fontSize: 11, color: Color(0xFFaaaaaa)))
                            ],
                          ),
                        ...
                        Container(
                          margin: const EdgeInsets.only(top: 5),
                          child: Text('${productListviewData[index].sale} Sale',
                              style: const TextStyle(
                                  fontSize: 11, color: Color(0xFFaaaaaa))),
                        ),
                      ],
