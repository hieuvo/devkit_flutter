...
import 'package:devkitflutter/ui/integration/firebase/firebase_list.dart';
...
class IntegrationTabPage extends StatefulWidget {
  const IntegrationTabPage({super.key});

  @override
  State<IntegrationTabPage> createState() => _IntegrationTabPageState();
}
      ...
      child: ListView(
        ...
        children: [
          _globalWidget.screenTabList(
              ...
              page: const MapsPackageListPage()
          ),
          _globalWidget.screenTabList(
              context: context,
              id: number++,
              ...
              page: (!kIsWeb)?const LocalNotificationListPage():const NotSupportedForWebPage()
          ),
          _globalWidget.screenTabList(
              context: context,
              id: number++,
