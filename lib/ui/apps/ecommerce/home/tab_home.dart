...
import 'package:devkitflutter/model/apps/ecommerce/category_for_you_model.dart';
...
import 'package:devkitflutter/model/apps/ecommerce/home_banner_model.dart';
import 'package:devkitflutter/model/apps/ecommerce/home_trending_model.dart';
...
class _TabHomePageState extends State<TabHomePage>
  ...
  void initState() {
    ...
    var flashsaleTime =
        timeNow.add(const Duration(seconds: 8000)).difference(timeNow);
    ...
    _scrollController = ScrollController()
      ..addListener(() {
        ...
        if (_scrollController.hasClients &&
          ...
          if (_topIconColor != blackGrey) {
            _topIconColor = blackGrey;
            ...
            slivers: [
              SliverList(
                ...
                Container(
                  ...
                  child:
                      const Text('Flash Sale', style: GlobalStyle.sectionTitle),
                ),
                Container(
                ...
                Container(
                  ...
                  child: const Text('Trending Product',
                ...
                Container(
                  margin: const EdgeInsets.only(top: 30, left: 16, right: 16),
                  child: const Text('Category For You',
                      style: GlobalStyle.sectionTitle),
                ),
  ...
  Widget _createCoupon() {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            color: softBlue, borderRadius: BorderRadius.circular(5)),
        child: const Row(
          children: [
            Expanded(
              child: Text(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('${homeTrendingData[index].sale} Product',
                          style:
                              const TextStyle(fontSize: 9, color: blackGrey))
                    ],
                  ),
                ),
              )
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      margin: const EdgeInsets.only(top: 5),
                      child: Text(
                          '\$ ${_globalFunction.removeDecimalZeroFormat(lastSearchData[index].price)}',
                          style: GlobalStyle.productPrice),
                    ),
                    Container(
                      margin: const EdgeInsets.only(top: 5),
                      child: Row(
                        children: [
                          ...
                          Text('(${lastSearchData[index].review})',
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                            '\$ ${_globalFunction.removeDecimalZeroFormat(recomendedProductData[index].price)}',
                            style: GlobalStyle.productPrice),
                        Text('${recomendedProductData[index].sale} Sale',
                            style:
