...
import 'package:devkitflutter/model/apps/food_delivery/coupon_model.dart';
import 'package:devkitflutter/ui/apps/food_delivery/add_address.dart';
...
import 'package:devkitflutter/ui/apps/food_delivery/coupon_detail.dart';
...
import 'package:devkitflutter/ui/apps/food_delivery/order_detail.dart';
import 'package:devkitflutter/ui/apps/food_delivery/order_history.dart';
import 'package:devkitflutter/ui/apps/food_delivery/order_status.dart';
import 'package:devkitflutter/ui/apps/food_delivery/restaurant_information.dart';
import 'package:devkitflutter/ui/apps/food_delivery/search_address.dart';
...
import 'package:devkitflutter/ui/apps/food_delivery/onboarding.dart';
import 'package:devkitflutter/ui/apps/food_delivery/splash_screen.dart';
import 'package:flutter/material.dart';

class FoodDeliveryListPage extends StatefulWidget {
  const FoodDeliveryListPage({super.key});

  @override
  State<FoodDeliveryListPage> createState() => _FoodDeliveryListPageState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ListView(
          ...
          children: [
            const Text('Food Delivery - Multi Merchants',
                style: TextStyle(
            ...
            _globalWidget.screenDetailList(
                context: context,
                title: 'Category Menu',
                page: const CategoryMenuPage(title: 'Nearby')),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Restaurant List',
                page: const RestaurantListPage(title: 'Food Around You')),
            _globalWidget.screenDetailList(
                context: context,
            ...
            _globalWidget.screenDetailList(
                context: context,
                title: 'Food List',
                page: const FoodListPage(title: 'Food on Promotion')),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Favorites Food List',
                page: const FavoritesFoodListPage()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Detail Food',
                page: const DetailFoodPage()),
            _globalWidget.screenDetailList(
                context: context, title: 'Cart', page: const CartPage()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Order Status',
                page: const OrderStatusPage()),
            _globalWidget.screenDetailList(
                context: context, title: 'Coupon', page: const CouponPage()),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Coupon Detail',
            ...
            _globalWidget.screenDetailList(
                context: context,
                title: 'Add Address',
                page: const AddAddressPage(fromList: true)),
            _globalWidget.screenDetailList(
                context: context,
                title: 'Order History',
