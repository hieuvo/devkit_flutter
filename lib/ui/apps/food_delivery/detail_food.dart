...
class _DetailFoodPageState extends State<DetailFoodPage> {
  ...
  final List<String> _chickenParts = [];
  final int _maxChickenParts = 2;
        ...
        children: [
          Container(
            ...
            child: ListView(
              ...
              children: [
                buildCacheNetworkImage(width: bannerWidth, height: bannerHeight, url: "$globalUrl/apps/food_delivery/food/1.jpg"),
          ...
          Opacity(
            ...
            child: SizedBox(
              ...
              child: AppBar(
                ...
                centerTitle: true,
                title: const Text('Chicken Rice Teriyaki', style: GlobalStyle.appBarTitle),
    ...
    return Column(
      ...
      children: [
        ...
        Container(
            ...
            child: const Text('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam eu risus nec arcu cursus accumsan in id felis.', style: GlobalStyle.detailFoodDesc, maxLines: 3, overflow: TextOverflow.ellipsis,)
        ),
    ...
    return GestureDetector(
      ...
      child: Row(
        children: [
          ...
          const Spacer(),
          Text(secondaryText, style: const TextStyle(
            fontSize: 13,
            color: black77,
          ))
        ],
        ...
        children: [
          Container(
            decoration: BoxDecoration(
              border: Border.all(
                width: 1,
                color: (_chickenParts.contains(value)) ? primaryColor : black77
              ),
