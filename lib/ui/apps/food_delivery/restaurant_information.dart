...
class RestaurantInformationPage extends StatefulWidget {
  ...
  @override
  State<RestaurantInformationPage> createState() => _RestaurantInformationPageState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text('Restaurant Information', style: GlobalStyle.appBarTitle),
    ...
    return Column(
      ...
      children: [
        Container(
          ...
          child: const Text('Address Detail', style: GlobalStyle.addressDetailTitle),
        ),
        const SizedBox(height: 8),
        Container(
          padding: const EdgeInsets.symmetric(horizontal: 16),
          child: const Text('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam eu risus nec arcu cursus accumsan in id felis. Lorem ipsum dolor sit amet, consectetur adipiscing elit.', style: GlobalStyle.addressDetailValue),
        )
      ],
    );
  }
  ...
  Widget _buildOpeningHours(){
    return Column(
      ...
      children: [
        Container(
          padding: const EdgeInsets.symmetric(horizontal: 16),
          child: const Text('Opening Hours', style: GlobalStyle.oph),
        ),
        const SizedBox(height: 8),
        Container(
          padding: const EdgeInsets.symmetric(horizontal: 16),
