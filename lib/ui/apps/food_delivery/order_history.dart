...
import 'package:devkitflutter/model/apps/food_delivery/order_history_model.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text('Order History', style: GlobalStyle.appBarTitle),
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        Flexible(
                          child: Text(orderData.name, style: const TextStyle(
                              fontSize: 13,
                        ...
                        Column(
                          ...
                          children: [
                            Text(orderData.date, style: const TextStyle(
                                fontSize: 11,
                                color: softGrey
                            )),
                            Text(orderData.time, style: const TextStyle(
                                fontSize: 11,
                                color: softGrey
                            )),
                          ],
                    ...
                    Text('${orderData.countItem} item', style: const TextStyle(
                      fontSize: 12,
                      color: softGrey
                    ))
                  ],
