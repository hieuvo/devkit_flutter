...
class FavoritesFoodListPage extends StatefulWidget {
  const FavoritesFoodListPage({super.key});

  @override
  State<FavoritesFoodListPage> createState() => _FavoritesFoodListPageState();
}
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: const Text('Favorites Food', style: GlobalStyle.appBarTitle),
