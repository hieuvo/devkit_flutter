...
class CupertinoTimerPicker2Page extends StatefulWidget {
  const CupertinoTimerPicker2Page({super.key});

  @override
  State<CupertinoTimerPicker2Page> createState() => _CupertinoTimerPicker2PageState();
}
...
class _CupertinoTimerPicker2PageState extends State<CupertinoTimerPicker2Page> {
  ...
  Duration _timerDuration = const Duration(hours: 2, minutes: 20, seconds: 57);
