...
class CoachMark {
  ...
  GlobalKey<HighlighterCoachMarkState>? globalKey;
  ...
  void show({
    ...
    if (duration != null) {
      await Future.delayed(duration).then((_) => close());
    }
  }
...
class _HighlighterCoachMarkWidget extends StatefulWidget {
  const _HighlighterCoachMarkWidget({
    super.key,
  ...
  @override
  HighlighterCoachMarkState createState() => HighlighterCoachMarkState();
}

class HighlighterCoachMarkState extends State<_HighlighterCoachMarkWidget>
...
class _CoachMarkLayer extends Listener {
  ...
  RenderPointerListener createRenderObject(BuildContext context) {
    return _RenderPointerListenerWithExceptRegion(
